 ...
 * Generated: 2026-01-06T14:28:19.961Z
 * Test ID: b5f8e9ea-5afe-4c43-803e-45cadfdff2d3
 * 
...
int vuser_init() {
    ...
    lr_save_string("Argos_Performance_Test_2026-01-06T14-28-19-961Z", "LTN");  // Load Test Name
...
int Action() {
    ...
    web_custom_request("ProductDiscovery_Journey_Step",
        ...
        "      \"substeps\": [{"substepName":"Search for Nintendo Switch Console","duration":1000},{"substepName":"View product detail page SKU: 123/4567 (£259.99)","duration":1000},{"substepName":"Search for Dyson V8 Vacuum Cleaner","duration":1000},{"substepName":"View product detail page SKU: 987/6543 (£299.99)","duration":1000}]"
        "    }"
        "  ],"
        "  \"additionalFields\": {},"
        "  \"customerProfile\": {"
    ...
    web_custom_request("BasketManagement_Journey_Step",
        ...
        "      \"substeps\": [{"substepName":"Add Nintendo Switch Console to basket","duration":1000},{"substepName":"Add Dyson V8 Vacuum Cleaner to basket","duration":1000},{"substepName":"Open basket and review items","duration":1000}]"
        "    }"
        "  ],"
        "  \"additionalFields\": {},"
        "  \"customerProfile\": {"
    ...
    web_custom_request("CheckoutInitiation_Journey_Step",
        ...
        "      \"substeps\": [{"substepName":"Enter contact details","duration":2000},{"substepName":"Select delivery for Dyson V8","duration":2000},{"substepName":"Select click & collect for Nintendo Switch","duration":1000}]"
        "    }"
        "  ],"
        "  \"additionalFields\": {},"
        "  \"customerProfile\": {"
    ...
    web_custom_request("PaymentProcessing_Journey_Step",
        ...
        "      \"estimatedDuration\": 3000,"
        "      \"substeps\": [{"substepName":"Enter card details","duration":1000},{"substepName":"3D Secure authentication","duration":1000},{"substepName":"Payment confirmation","duration":1000}]"
        "    }"
        "  ],"
        "  \"additionalFields\": {},"
        "  \"customerProfile\": {"
    ...
    web_custom_request("FulfilmentAllocation_Journey_Step",
        ...
        "      \"substeps\": [{"substepName":"Allocate Dyson V8 to home delivery slot","duration":1000},{"substepName":"Reserve Nintendo Switch at local store","duration":1000}]"
        "    }"
        "  ],"
        "  \"additionalFields\": {},"
        "  \"customerProfile\": {"
    ...
    web_custom_request("DeliveryCompletion_Journey_Step",
        ...
        "      \"substeps\": [{"substepName":"Home delivery of Dyson V8 (next day)","duration":720000},{"substepName":"Click & collect pickup of Nintendo Switch","duration":720000}]"
        "    }"
        "  ],"
        "  \"additionalFields\": {},"
        "  \"customerProfile\": {"
